                                ...
                                <div class="content mb-5">
                                    ...
                                    <div class="link-source mt-3">
                                        @foreach ($chapter->lessons as $lesson)
                                            <div
                                                class="link d-flex align-items-center mb-3 {{ request()->route('episode') === $lesson->slug_episode ? 'active-course' : '' }}">
                                                <a href="{{ route('member.course.play', ['slug' => $slug, 'episode' => $lesson->slug_episode]) }}"
